...
class TestStudent(unittest.TestCase):
	def setUp(self):
		create_student({"first_name": "_Test Name", "last_name": "_Test Last Name", "email": "_test_student@gmail.com"})
		make_program_and_linked_courses("_Test Program 1", ["_Test Course 1", "_Test Course 2"])

	def test_create_student_user(self):
		self.assertTrue(bool(frappe.db.exists("User", "_test_student@gmail.com")))
		frappe.db.rollback()

	def test_enroll_in_program(self):
		student = get_student("_test_student@gmail.com")
