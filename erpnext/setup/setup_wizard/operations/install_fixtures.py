...
def install(country=None):
	records = [
		...
		# item group
		{'doctype': 'Item Group', 'item_group_name': _('All Categories'),
			'is_group': 1, 'parent_item_group': '', "show_in_website": 1},
		{'doctype': 'Item Group', 'item_group_name': _('Fishes'),
			'is_group': 1, 'parent_item_group': _('All Categories'), "show_in_website": 1 },
		{'doctype': 'Item Group', 'item_group_name': _('Big Fish'),
			'is_group': 0, 'parent_item_group': _('Fishes'), "show_in_website": 1 },
		{'doctype': 'Item Group', 'item_group_name': _('Small Fish'),
			'is_group': 0, 'parent_item_group': _('Fishes'), "show_in_website": 1 },
		{'doctype': 'Item Group', 'item_group_name': _('Prawns'),
			'is_group': 1, 'parent_item_group': _('All Categories'), "show_in_website": 1 },
		{'doctype': 'Item Group', 'item_group_name': _('Big Prawns'),
			'is_group': 0, 'parent_item_group': _('Prawns'), "show_in_website": 1 },
		{'doctype': 'Item Group', 'item_group_name': _('Small Prawns'),
			'is_group': 0, 'parent_item_group': _('Prawns'), "show_in_website": 1 },

		{'doctype':"Homepage","slideshow":"Slideshow","hero_section_based_on":"Slideshow"},
		...
		{'doctype':"Payment Gateway Account","payment_gateway":"Razorpay","is_default":1,"currency":"INR","payment_account":"Razorpay - FC","message":"Please click on the link below to make your payment"},

		{"doctype":"Tax Rule","tax_type":"Sales","use_for_shopping_cart":1,'sales_tax_template': "Inclusive Tax - Ecom","customer_group":_("All Customer Groups"),"billing_country":"India","shipping_country":"India","priority":"1"},
        ...
        {'doctype': "Item Attribute", "attribute_name": _("Unit of Measure"), "item_attribute_values": [
			{"attribute_value": _("Kg"), "abbr": "Kilogram"},
			{"attribute_value": _("Gram/Litre"), "abbr": "Gram"},
			{"attribute_value": _("Box"), "abbr": "Box"}
		]},
		...
		{'doctype': "Email Account", "email_id": "sales@gmail.com", "append_to": "Opportunity"},
		{'doctype': "Email Account", "email_id": "support@gmail.com", "append_to": "Issue"},
		{'doctype': "Email Account", "email_id": "jobs@gmail.com", "append_to": "Job Applicant"},
...
def install_defaults(args=None):
	...
	records = [
		...
		# Shopping cart: needs price lists
		{
            ...
            "show_configure_button": 1,
            "show_contact_us_button": 0,
            "show_quantity_in_website": 1,
            "show_apply_coupon_code_in_website": 1,
            'company': args.company_name,
        # uh oh
            'price_list': frappe.db.get_value("Price List", {"selling": 1}),
            'default_customer_group': _("All Customer Groups"),'quotation_series': "SAL-QTN-.YYYY.-",
            "enable_checkout": 1,
