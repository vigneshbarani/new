...
class TestSalesOrder(unittest.TestCase):
	...
	def test_warehouse_user(self):
		frappe.permissions.add_user_permission("Warehouse", "_Test Warehouse 1 - _TC", "test@gmail.com")
		frappe.permissions.add_user_permission("Warehouse", "_Test Warehouse 2 - _TC1", "test2@gmail.com")
		frappe.permissions.add_user_permission("Company", "_Test Company 1", "test2@gmail.com")

		test_user = frappe.get_doc("User", "test@gmail.com")
		test_user.add_roles("Sales User", "Stock User")
		test_user.remove_roles("Sales Manager")

		test_user_2 = frappe.get_doc("User", "test2@gmail.com")
		...
		frappe.set_user("Administrator")
		frappe.permissions.remove_user_permission("Warehouse", "_Test Warehouse 1 - _TC", "test@gmail.com")
		frappe.permissions.remove_user_permission("Warehouse", "_Test Warehouse 2 - _TC1", "test2@gmail.com")
		frappe.permissions.remove_user_permission("Company", "_Test Company 1", "test2@gmail.com")
