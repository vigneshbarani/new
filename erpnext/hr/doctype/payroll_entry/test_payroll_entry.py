...
class TestPayrollEntry(unittest.TestCase):
	...
	def test_payroll_entry_with_employee_cost_center(self): # pylint: disable=no-self-use
		...
		employee1 = make_employee("test_employee1@gmail.com", payroll_cost_center="_Test Cost Center - _TC",
			department="cc - _TC", company="_Test Company")
		employee2 = make_employee("test_employee2@gmail.com", payroll_cost_center="_Test Cost Center 2 - _TC",
			department="cc - _TC", company="_Test Company")
